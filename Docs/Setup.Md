...
- Build out the detection layer further: MITRE ATT&CK mapping, Sigma rules, more Atomic Red Team tests. First test (T1059.001, obfuscated PowerShell) is done, see Docs/Detections.md.
